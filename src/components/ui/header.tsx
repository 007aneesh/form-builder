...
import { navItems as navItemsType } from "@/@types/nav_items";
    ...
    <AnimatePresence mode="sync">
      ...
      >
        ...
        <button
          ...
          className="text-lg lg:text-base font-medium relative  text-black dark:text-white"
        >
          <IconUser className="h-6 w-6 text-neutral-500 dark:text-white" />
        </button>
      </motion.div>
    </AnimatePresence>
  );
